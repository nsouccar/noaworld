...
export const hotspots: Hotspot[] = [
  ...
  },
  {
    id: 'me',
    name: 'Me',
    // Looking at the picture frame - adjusted for orbit constraints (more horizontal view)
    cameraPosition: new THREE.Vector3(0.4, 0.7, -1.7),
    lookAt: new THREE.Vector3(0.4, 0.65, -2.3),
